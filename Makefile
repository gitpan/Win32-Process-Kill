# This Makefile is for the Win32::Process::Kill extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Win32/Process/Kill.pm]
#     AUTHOR => q[Baggio, Kwok Lok Chung  <lokchungk@hotmail.com>]
#     DEFINE => q[]
#     INC => q[-I.]
#     LIBS => [q[]]
#     NAME => q[Win32::Process::Kill]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Win32/Process/Kill.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Win32/Process/Kill.pm
...
TO_INST_PM = lib/Win32/Process/Kill.pm

PM_TO_BLIB = lib/Win32/Process/Kill.pm \
	blib\lib\Win32\Process\Kill.pm
...
XSUBPPDIR = C:\Perl\site\lib\ExtUtils
...
DISTNAME = Win32-Process-Kill
DISTVNAME = Win32-Process-Kill-1.0
...
# Win32::Process::Kill might depend on some other libraries:
# See ExtUtils::Liblist for details
#
LDLOADLIBS = -lkernel32 -luser32 -lgdi32 -lwinspool -lcomdlg32 -ladvapi32 -lshell32 -lole32 -loleaut32 -lnetapi32 -luuid -lws2_32 -lmpr -lwinmm -lversion -lodbc32 -lodbccp32 -lmsvcrt
...
Kill.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Win32::Process::Kill\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
OTHERLDFLAGS = -Wl,--image-base,0x650d0000 
INST_DYNAMIC_DEP = 
...
manifypods : pure_all  \
	lib/Win32/Process/Kill.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Win32/Process/Kill.pm $(INST_MAN3DIR)\Win32.Process.Kill.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:                Win32-Process-Kill" >> META_new.yml
	$(NOECHO) $(ECHO) "version:             1.0" >> META_new.yml
	$(NOECHO) $(ECHO) "abstract:            Perl extension for Terminating Process in Win32 (R3)" >> META_new.yml
	$(NOECHO) $(ECHO) "license:             ~" >> META_new.yml
	$(NOECHO) $(ECHO) "author:              " >> META_new.yml
	$(NOECHO) $(ECHO) "    - Baggio, Kwok Lok Chung  <lokchungk@hotmail.com>" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Perl extension for Terminating Process in Win32 (R3)</ABSTRACT>" >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')" -- \
	  lib/Win32/Process/Kill.pm blib\lib\Win32\Process\Kill.pm 
